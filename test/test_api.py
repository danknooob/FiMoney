...
def test_register_user():
    payload = {"name": "Puja", "email": "puja@example.com", "password": "Password1!"}
...
def test_login():
    payload = {"email": "puja@example.com", "password": "Password1!"}
    ...
    if res.status_code == 200:
        try:
            ...
            passed = False
    print_result("Login Test", passed, {"email": payload["email"], "password": payload["password"]}, res.text, payload, res.text)
    return token
